...
model = load_model('best_disease_risk_model_auc_roc.keras', compile=False)
...
plt.tight_layout()
plt.savefig('threshold_optimization_auc_roc.png')
print("График 'threshold_optimization_auc_roc.png' успешно сохранен!")
